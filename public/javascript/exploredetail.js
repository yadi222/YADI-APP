...
$.ajax({
    ...
    success: function(res){
        ...
        $('#jumlahpengikut').html(res.dataJumlahFollow.jmlfolow + ' Follower')
        $('#username').prop('href', '/profil_public/'+res.dataDetailFoto.users.id)
        ambilKomentar()
        var idUser ;
        ...
        if(res.dataDetailFoto.users_id === res.dataUser){
            ...
            if(idUser == res.dataUser){
                $('#tombolfollow').html(' <button class="border px-4 rounded-full bg-white text-black border-black" onclick = "ikuti(this, '+res.dataDetailFoto.users_id+')">Mengikuti</button>')
            } else {
                $('#tombolfollow').html(' <button class="px-4 rounded-full bg-black text-white" onclick = "ikuti(this, '+res.dataDetailFoto.users_id+')">Ikuti</button>')
            }
        }
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="w-[363px] h-[192px] overflow-hidden rounded-md">
                                        <img src="/postingan/${x.foto}" alt=""
                                            class="w-full transit   ion duration-500 ease-in-out hover:scale-105">
                                    </div>
