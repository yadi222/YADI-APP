...
@section('content')
    <section class="mt-32">
        <div class="items-center max-w-screen-md mx-auto">
            <h3 class="text-5xl text-center font-kaushan">GALLERY</h3>
        </div>
    </section>
                        ...
                        <div class="flex flex-col flex-wrap ">
                            ...
                            <div class="flex flex-row justify-between gap-2">
                                ...
                                <button type="button" data-modal-target="crud-modal" data-modal-toggle="crud-modal"
                                    class= "w-full py-2 text-white  bg-black rounded-md hover:bg-orange-600" type="button">
                                    +Album
                                </button>
                                <!-- Main modal -->
                            </div class = "ms-2">
                            ...
                            <div class="flex flex-row justify-between">
                                <button type="submit" class="w-full py-2 text-white  bg-black hover:bg-orange-600 rounded-md">Upload</button>
                            </div>
                            <br>
                        </div>
                    </div>
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5">
                        ...
                        <button type="submit" class="w-full py-2 text-white rounded-full bg-black hover:bg-orange-600">Tambah</button>
                    </div>
                    <script>
